...
1) They are always seekable												http://php.net/manual/en/function.stream-get-meta-data.php
2) When used properly they significantly reduce memory consumption
3) They can be applied to any data source
4) They are always bi-directional										http://php.net/manual/en/function.fopen.php
